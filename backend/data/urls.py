...
router.register(r'raster-datasets', views.RasterDatasetViewSet, basename='raster-datasets')
router.register(r'raster-jobs', views.RasterJobViewSet, basename='raster-jobs')
